/**
𝐌𝐔𝐍̃𝐄𝐂𝐀 𝐁𝐎𝐓 @josssi_bot.ff - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '50766454639-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐌𝐔𝐍̃𝐄𝐂𝐀 𝐁𝐎𝐓', 'jpegThumbnail': null } } };
