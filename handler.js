...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/50766454639) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/KillzN/Muneca-Bot1/master/src/avatar_contact.png';
          try {
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;����� 👑;;;\nFN:����� 👑\nORG:����� 👑\nTITLE:\nitem1.TEL;waid=50766454639:+521 999 209 5479\nitem1.X-ABLabel:����� 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:����� 👑\nEND:VCARD`;
